...
import { getCurrentUser, getUserChannelProfile, getWatchHistory, refreshAccessToken, updateCoverImage, updatedCurrentPassword, updateUserAccount, updateUserAvatar, userLoggedOut, userLogin, userRegister } from "../controllers/user.controller.js";
...
userRouter.route("/update-password").post(verifyJWT, updatedCurrentPassword)
